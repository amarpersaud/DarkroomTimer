...
get_max_step_id(){if(this.sub_steps.length==0){return this.step_id;}
let current_max=0;for(let i=0;i<this.sub_steps.length;i++){if(this.sub_steps[i].step_id>current_max){current_max=this.sub_steps[i].step_id;}}
return current_max;}}
