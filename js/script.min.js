...
class DevelopmentProfile{RootStep=null;ProfileName="Unnamed Profile";PourInTime=0;PourOutTime=0;constructor(RootStep,ProfileName,PourInTime,PourOutTime){this.RootStep=RootStep;this.ProfileName=ProfileName;this.PourInTime=PourInTime;this.PourOutTime=PourOutTime;}}
...
function ImportProfile(){let inp=document.getElementById("profileFile");if(inp.files.length==1){try{var reader=new FileReader();reader.readAsText(inp.files[0],'UTF-8');reader.onload=readerEvent=>{var content=readerEvent.target.result;let loadedProfile=JSON.parse(content);CurrentProfile=loadedProfile;refreshUI();}}
